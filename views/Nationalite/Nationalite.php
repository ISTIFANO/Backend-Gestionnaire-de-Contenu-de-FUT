    ...
    <main class="w-screen h-screen flex">
        ...
        <section class="ml-[250px] w-full py-6 px-4">
                    ...
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-800 whitespace-nowrap">
                            <tr>
                                ...
                                <th class="p-4 text-left text-sm font-medium text-white">
                                    <a class="mr-4" title="Edit" onclick="showModal()" href="#">
                        ...
                        <tr class="bg-blue-50">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($resultat)) { ?>
                                ...
                                <td class="p-4 text-sm text-black"><img src=<?php echo $row["flag"]; ?> class="h-8" alt="player" /></td>
                                <td>
                                    <?php echo $row["name"];  ?>
                                </td>
                                ...
                                <td class="p-4 flex justify-center">
                                    <button class="mr-4"  title="Edit">
                                        <a href="Upadate.php?updateId=<?php echo ($row["id"])?>">
                                    ...
                                    <!-- <div id="modalEdit" class="modalEdit">
                                        <div class="modal-content">
                                            ...
                                            <form method="get" action="./Upadate.php">
                                                <div class="mb-4">
                                                    <label for="name" class="block text-sm font-medium text-gray-700">Name</label>
                                                    <input type="text" value= id="name" name="nameEdit" class="mt-1 block w-full border border-black border-2 rounded-lg shadow-sm" required>
                                                </div>

                                                <div class="mb-4">
                                                    <label for="flag" class="block text-sm font-medium text-gray-700">Flag</label>
                                                    <input type="text" id="flag" value=ame="flagEdit" class="mt-1 block w-full border border-black border-2 rounded-lg shadow-sm" required>
                                                </div>
            ...
            <button class="mr-4" title="Delete">
                <!-- <input type="hidden" name="idD" value=<?php $row ?> -->
                <a href="Supprission.php?id=<?php echo ($row["id"]) ?>">
