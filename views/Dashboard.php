...
<section class="bg-white shadow-lg h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto">
      <a href="javascript:void(0)"><img src="../public/img/pl-main-logo.png" alt="logo" class='w-[160px] h-24' />
      </a>
      <ul class="mt-6">
        <li>
