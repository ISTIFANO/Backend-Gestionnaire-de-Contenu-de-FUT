...
WHERE Players.position_player <> 'GK';";
   ...
   <section class="h-1/2 overflow-auto " > <div class="font-[sans-serif] overflow-x-auto">
      ...
      while ($row = mysqli_fetch_assoc($resultat)) {
        ...
        ?>
            ...
            <td class="p-4 text-sm text-black"><img src=<?php echo $row["PlayerPic"]; ?> class="h-8" alt="player" /></td> 
            <td>
             ...
             <img src= <?php echo $row["logo"]; ?>  class="h-8" alt="player" />
             
             </td>
               <td class="p-4 text-sm text-black">
             
             <img src= <?php echo $row["Flag"] ;?> class="h-8" alt="player" />
             
             </td>
     
            <td class="p-4 text-sm text-black"><?php echo $row["Rating"] ;?>
            </td>
            <td class="p-4 text-sm text-black"><?php echo $row["physical"] ;?>
          
            </td>
            <td class="p-4 text-sm text-black"><?php echo $row["defending"] ;?>
          
            </td>
            <td class="p-4 text-sm text-black"><?php echo $row["dribbling"]; ?>
          
            </td>
            <td class="p-4 text-sm text-black"><?php echo $row["pace"]; ?>
          
            </td>
            <td class="p-4 text-sm text-black"><?php echo $row["passing"] ;?>
          
            </td>
              <td class="p-4">
              <button class="mr-4" title="Edit">
              <a href="../CrudJoueurs/Modifier.php?id=<?php echo$row["id"]?>&stisticId=<?php echo$row["stisticId"];?>&Natid=<?php echo(intval($row["Natid"]));?>&idClubs=<?php echo$row["idClubs"];?>">
  ...
  <path id="Path_19" data-name="Path 19" d="M256,512C114.625,512,0,397.391,0,256S114.625,0,256,0C397.391,0,512,114.609,512,256S397.391,512,256,512Zm0-448C149.969,64,64,149.969,64,256s85.969,192,192,192c106.047,0,192-85.969,192-192S362.047,64,256,64Zm32,320H224V288H128V224h96V128h64v96h96v64H288Z" fill-rule="evenodd"/>
              ...
              <button class="mr-4" title="Delete">
                <a href="../CrudJoueurs/Supprimer.php?delete=<?php echo$row["id"];?>">
      ...
      $query = "SELECT Players.position_player,Players.id AS id,Players.name AS playerName,Nationalities.flag AS Flag,Players.photo AS PlayerPic,Rating,Clubs.logo AS logo,
            diving,
            handling,
            kicking,
            reflexes,
      ...
      <section> <div class="font-[sans-serif] overflow-x-auto">
<table class="min-w-full bg-white">
<thead class="bg-gray-800 whitespace-nowrap">
<tr>
<th class="p-4 text-left text-sm font-medium text-white">
...
<td class="p-4 text-sm text-black"> <?php echo $row["diving"];?>
    
</td>
<td class="p-4 text-sm text-black"> <?php echo $row["handling"];?>
          
</td>
<td class="p-4 text-sm text-black"><?php  echo $row["kicking"];?>
    
</td>
<td class="p-4 text-sm text-black"> <?php  echo $row["reflexes"];?>
          
</td>
<td class="p-4 text-sm text-black"><?php  echo $row["speed"];?>
    
</td>
</td>
<td class="p-4 text-sm text-black"> <?php echo $row["positioning"];?>
...
<td class="p-4">
  <button class="mr-4" title="Edit">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-500 hover:fill-blue-700"
      ...
      <button class="mr-4" title="ADD">
      <a href="#modalEdit"  onclick="showModalEdit()" >
<svg fill="#000000" width="20px" height="40px" viewBox="0 0 512 512" id="_14_Add" data-name="14 Add" xmlns="http://www.w3.org/2000/svg">
<path id="Path_19" data-name="Path 19" d="M256,512C114.625,512,0,397.391,0,256S114.625,0,256,0C397.391,0,512,114.609,512,256S397.391,512,256,512Zm0-448C149.969,64,64,149.969,64,256s85.969,192,192,192c106.047,0,192-85.969,192-192S362.047,64,256,64Zm32,320H224V288H128V224h96V128h64v96h96v64H288Z" fill-rule="evenodd"/>
</svg>
</a>
  ...
  <a href="../CrudJoueurs/Supprimer.php?delete=<?php echo$row["id"];?>">
    ...
    <?php } ?>
      ...
      <div id="modalEdit"
        class="items-center justify-center hidden relative ">
...
?>
        ...
        <select name="PlayerPosition" class="mt-1.5 w-full rounded-lg border-gray-300 text-gray-700 sm:text-sm" required>';
         <?php     while ($row = mysqli_fetch_assoc($resultat)) { ?>
           <option value="<?php echo $row['id']; ?>"><?php echo $row['position_player']; ?></option>
       ...
       <div class="w-1/2">
        ...
        <select name="NationalitiesPlayer" class="mt-1.5 w-full rounded-lg border-gray-300 text-gray-700 sm:text-sm" required>
           <?php   while ($row = mysqli_fetch_assoc($nationnalitee)) {
          ...
          <?php
           ...
           ?>
              ...
              <div class="w-1/2 flex flex-row">
                ...
                <input id="Flag" type="text" name="LogoPlayer" class="mt-1 block w-48 border border-black border-2 rounded-lg shadow-sm" required>
              </div>
