...
<body class="bg-gradient-to-r from-[#2DBAFF] via-[#2DBAFF] to-[#83b3963d]">
    ...
    <div id="content-area">
            ...
            <table class="min-w-full bg-white">
                ...
                <tbody>
                    ...
                    if (isset($_GET["updateId"])) {
                        ...
                        $stmt = $conn->query("SELECT *FROM Clubs WHERE id = $idUpdate ");
                    ...
                    ?>
                            <tr class="bg-blue-50">
                                <td class="p-4 text-sm text-black">
                                    <img src="<?php echo $arr["logo"]; ?>" class="h-8" alt="player" />
                                </td>
                                <td class="p-4 text-sm text-black">
                                    <?php echo $arr["name"]; ?>
                                </td>
      ...
      <input type="text"  value=<?php echo $arr["logo"]; ?>
...
<a   class="!mt-8 w-full px-4 py-2.5 mx-auto block text-sm bg-blue-500 text-white rounded hover:bg-blue-600"  href="Update.php?id=<?php echo $arr["id"];?>&logo=<?php echo $arr["logo"];?>&name=<?php echo $arr["name"];?>">Submit</a>
    </form>
        </div>
    </div>
</section>
